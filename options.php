 ...
 *
 * If you are making your theme translatable, you should replace 'pinkcharityblog'
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Header Meta', 'pinkcharityblog'),
		'type' => 'heading');

// Standard Meta
	$options[] = array(
		'name' => __('Head ID', 'pinkcharityblog'),
		'desc' => __("", 'pinkcharityblog'),
		'id' => 'meta_headid',
		'std' => 'pinkcharityblog',
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'pinkcharityblog'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'pinkcharityblog'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'pinkcharityblog'),
		'desc' => __('Populates meta author tag.', 'pinkcharityblog'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'pinkcharityblog'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'pinkcharityblog'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'pinkcharityblog'),
		'desc' => __('', 'pinkcharityblog'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'pinkcharityblog'),
		'desc' => __('', 'pinkcharityblog'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'pinkcharityblog'),
		'desc' => __('Application Name', 'pinkcharityblog'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'pinkcharityblog'),
		'desc' => __('Tile Color', 'pinkcharityblog'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'pinkcharityblog'),
		'desc' => __('Tile Image', 'pinkcharityblog'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'pinkcharityblog'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'pinkcharityblog'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'pinkcharityblog'),
		'desc' => __('twitter:site (@username of website)', 'pinkcharityblog'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'pinkcharityblog'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'pinkcharityblog'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'pinkcharityblog'),
		'desc' => __('twitter:description (maximum 200 characters)', 'pinkcharityblog'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'pinkcharityblog'),
		'desc' => __('twitter:url (url for the content)', 'pinkcharityblog'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'pinkcharityblog'),
		'desc' => __('og:title', 'pinkcharityblog'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'pinkcharityblog'),
		'desc' => __('og:description', 'pinkcharityblog'),
		'id' => 'meta_app_fb_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'pinkcharityblog'),
		'desc' => __('og:url', 'pinkcharityblog'),
		'id' => 'meta_app_fb_url',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'pinkcharityblog'),
		'desc' => __('og:image', 'pinkcharityblog'),
